    ...
    return (
      ...
      <FormControl fullWidth>
        ...
        <br />
          ...
          <Button onClick={this.props.handleChange(this.state.qualiDetails)} color="transparent" variant='contained' style={{"margin-top":"20px","fontWeight":"700"}}>Add Details</Button>
